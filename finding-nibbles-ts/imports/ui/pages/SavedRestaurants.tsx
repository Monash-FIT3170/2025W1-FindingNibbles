...
export const SavedRestaurantsList = () => {
  ...
  useEffect(() => {
    ...
    const computation = Tracker.autorun(() => {
      ...
      // Use a nested autorun to watch for subscription readiness and data changes
      ...
      // Clean up nested computation when user changes
              ...
              restaurants.map((restaurant) => (
                ...
                >
                  ...
                  {restaurant.cuisine && restaurant.cuisine.length > 0 && (
                    <p className="text-sm text-gray-700">Cuisine: {restaurant.cuisine.join(', ')}</p>
                  )}
                </div>
              ))
            ) : (
